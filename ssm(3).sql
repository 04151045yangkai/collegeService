...
insert  into `account`(`idCard`,`AuserId`,`politics`,`nation`,`majorField`,`birthday`,`archivesInSchool`,`rResidenceInSchool`,`archivesPath`,`rResidencePath`,`qqNum`,`phoneNum`,`email`) values 
('123',123,'群众','少数民族','计算机','2019-06-12','no','yes','西安','西安',897088670,85825131,'3200337870@qq.com'),
('456',456,'共青团员','汉族','金融','2019-03-28','no','no','西安','西安',897088671,85825132,'3200337871@qq.com'),
('789',789,'中共党员','少数民族','航天','2019-03-21','yes',NULL,'北京','北京',897088672,85825133,'3200337872@qq.com');
...
insert  into `birthplace`(`birthId`,`birthPath`,`cityOrTownShip`,`address`,`homePhone`,`zipCode`,`isSubAllowance`) values 
(123,'西安','农村','长安区',85825158,710101,'yes'),
(456,'西安','农村','莲湖区',85825169,710102,'no'),
(789,'北京','城镇','雁塔区',85825167,710103,'no');
...
insert  into `certificateobtain`(`coStuId`,`coScId`) values 
(123,135),
(456,246),
(789,369);
...
insert  into `employmentinfo`(`eiID`,`eiGraduation`,`eiUnitName`,`eiOriganizationCode`,`eiUnitProperties`,`eiUnitPIndustry`,`eiCompanyAddress`,`eiJobPosition`,`eiContacts`,`eiContactsPhone`,`eiContactEmail`,`eiZipCode`,`eiFileForwardName`,`eiFileForwardAddress`,`eiFFzipCode`,`eiTransferHousehold`) values 
(123,'北京','中软','123456','部队,高等教育单位','建筑业','北京','法律专业人员','Mary',85825125,'3200357595@qq.com','720506','公安局','西安',710105,'北京'),
(456,'上海','中软','456789','党政机关公务员,国有企业','电力','上海','公务员','Jack',85825126,'3200347595@qq.com','720507','派出所','西安',710106,'上海'),
(789,'广州','中软','345678','其他企业,应征入伍','建筑业','广州','法律专业人员','xiaowang',85825127,'3200367595@qq.com','720508','民政局','西安',710107,'广州');
...
insert  into `login`(`userId`,`passWord`,`userFlag`) values 
(123,'123456',1),
(456,'234567',0),
(789,'345678',1);
...
insert  into `obtainemployment`(`oeId`,`oeIntent`,`oeIntentCity`,`oeIntentSalary`) values 
(123,'出国出境','西安','5000-7000'),
(456,'应征入伍','北京','3000一下'),
(789,'自主创业','上海','7000-9000');
...
insert  into `poorstudentcard`(`poorId`,`poorState`,`pObtainProgress`,`pHelpContent`,`pHelpContacts`,`pHelpPhone`) values 
(123,'特别贫困','进行中','助学金','wang',85825136),
(456,'一般贫困','已进行','助学金','li',85825137),
(789,'特别贫困','未进行','助学金','tang',85825138);
...
insert  into `skillcertificate`(`scID`,`scName`,`scContent`) values 
(135,'abc','der'),
(246,'efg','hig'),
(369,'kil','lio');
